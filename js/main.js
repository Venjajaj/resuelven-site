...
const I18N = {
  en: {
    ...
    studio_lead: "We develop digital-native productions and hybrid shoots. Whether the project is fully digital or hybrid, we adapt the production to the creative vision, the budget and the time available.",
  ...
  es: {
    ...
    studio_lead: "Desarrollamos producciones nativas digitales y rodajes híbridos. Ya sea un proyecto 100% digital o híbrido, adaptamos la producción a la visión creativa, el presupuesto y el tiempo disponible.",
